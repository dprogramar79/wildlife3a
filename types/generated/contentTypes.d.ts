...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    role: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.role'
    >;
    loginMethod: Schema.Attribute.Enumeration<['Google', 'Phone Number']> &
      Schema.Attribute.Required;
...
export interface ApiEnquiryEnquiry extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    lastFollowed: Schema.Attribute.DateTime;
    statusOfEnquiry: Schema.Attribute.Enumeration<['active', 'non acive']> &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'active'>;
    enquiryCode: Schema.Attribute.String & Schema.Attribute.Required;
    message: Schema.Attribute.String & Schema.Attribute.Required;
    enquiryFor: Schema.Attribute.Enumeration<
...
export interface ApiNationalParkNationalPark
  extends Struct.CollectionTypeSchema {
...
export interface ApiPackagePackage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    campsite: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    logitude: Schema.Attribute.Decimal &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    enquiry: Schema.Attribute.Relation<'oneToOne', 'api::enquiry.enquiry'>;
    term_conditions: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiRefferalIdRefferalId extends Struct.CollectionTypeSchema {
  collectionName: 'refferal_ids';
  info: {
  ...
  attributes: {
    myReferral: Schema.Attribute.JSON;
    myReferralCount: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiRiverRiver extends Struct.CollectionTypeSchema {
...
export interface ApiTermConditionTermCondition
  extends Struct.CollectionTypeSchema {
